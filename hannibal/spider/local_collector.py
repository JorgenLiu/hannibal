...
class LocalCollector(object):
    ...
    def __init__(self, collect_queue, parse_function, href_pool, seed_mission=None, cache_size=3, *args, **kwargs):
    ...
    def register_middleware(middleware, attach_to='before_collect', *args, **kwargs):
        ...
        if attach_to == 'after_collect':
            LocalCollector._AFTER_COLLECT_MIDDLEWARE_LIST.append(middleware)
